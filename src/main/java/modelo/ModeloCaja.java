...
public class ModeloCaja {
    ...
    public static ModeloCaja getModelo() {
        if (instancia == null) instancia = new ModeloCaja();
        return instancia;
    }
    ...
    public boolean autosave(String ruta) {
        ...
        if (auto.escribir((ArrayList<EntradaCaja>) caja)) return true; else return false;
    }

    public boolean guardarListaCajas(ArrayList<EntradaCaja> lista) {
        if (ficheroCJA.escribir(lista)) return true; else return false;
    }
    ...
    public boolean guardarCaja(EntradaCaja c) {
        ...
        // TODO - 2024-05-06 : - Estudiar el cambio en la clase 'Caja' que ha pasado a un Java record 'EntradaCaja'
        if (guardarListaCajas((ArrayList<EntradaCaja>) caja)) return true; else return false;
    }
...
// NOTE - 26-03-10 : Anulo, por el momento, todo lo que tenga que ver con la clase Vector, obsoleta...
    /*
...
*/
    ...
    public List<EntradaCaja> leerCaja() {
        ficheroCJA = new Fichero<EntradaCaja>(Config.getConfig().getRutaCJA());
