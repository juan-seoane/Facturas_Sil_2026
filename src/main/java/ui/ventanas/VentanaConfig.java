...
*/    
    public void cargarDatos(){
        ...
        if (Config.getConfigActual().misDatos.nif().isCIF())
            this.txtNIFLetraCIFMiRS.setText(Config.getConfigActual().misDatos.nif().letra());
        else
            this.txtNIFLetraMiRS.setText(Config.getConfigActual().misDatos.nif().letra());
...
*/        
        String ivas = "";
         for (Integer iva : Config.getConfigActual().configData.tiposIVA())
             ivas += iva +",";
         ivas = ivas.substring(0,ivas.length()-1);
        this.txtTiposIVA.setText(ivas);
        this.txtRutaFacturas.setText(Config.getConfigActual().getRutaFCT().substring(0,Config.getConfigActual().getRutaFCT().lastIndexOf(".")));
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtAnhoConfig, javax.swing.GroupLayout.DEFAULT_SIZE, 72, Short.MAX_VALUE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel1)
                    .addComponent(txtAnhoConfig, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
