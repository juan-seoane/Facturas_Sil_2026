...
src/main/java/
    1-model/          <!-- lógica del dominio (qué es una factura) -->
    ...
    2-business/       <!-- lógica de negocio (qué hace esta empresa con las facturas) -->
        filtros/                        <!-- filtros y lógica funcional (streams, predicados) -->
        interfaces/                     <!-- Interfaces de negocio (casos de uso): FacturaService, InformeService, ValidadorFactura -->
        repositories/                   <!-- adaptadores de acceso a datos -->
            interfaces/                 <!-- Interfaces de repositorio: FacturaRepository, InformeRepository -->
            json/
            csv/
            informes/
...
data/                 <!-- datos guardados, persistencia -->
    ...
    datos/
        $USERNAME/
            informes/               <!-- informes generados (PDF, HTML, etc.) -->
